...
class OltCmtsExtraccionFijaController
{
    private $finder;
    private $exporter;
    ...
    public function view()
    {
        $config = [
            'title' => 'OLT',
            'url' => url('olt-cmts/trabajo-mantenimiento/export'),
            'searchApi' => url('olt-cmts/trabajo-mantenimiento/search'),
            'exportFinalApi' => url('olt-cmts/trabajo-mantenimiento/export-final'),
            'findValuesApi' => url('olt-cmts/trabajo-mantenimiento/find-values'),
        ...
        return view("olt_cmts.olt_cmts_extraccion_fija", compact("config"));
    }
    ...
    {
        $response = $this->informeFinder->getTrabajosMantenimiento();
