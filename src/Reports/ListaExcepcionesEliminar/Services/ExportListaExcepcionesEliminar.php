...
class ExportListaExcepcionesEliminar
{
    private $repo;
    private $exportService;

    public function __construct(ListaExcepcionesEliminarRepository $repo, ExportService $exportService)
    {
        $this->repo = $repo;
    ...
    public function __invoke($imei)
    {
        ...
        return Response::respData([
            "filename" => "Lista_Excepciones_Eliminar_{$strDate}.xlsx",
            "content" => $content,
        ]);
    }
    ...
    private function export($data)
    {
        $headers = [
            ...
            "imsi" => ["label" => "IMSI"],
            "estado" => ["label" => "ESTADO"],
            "ejecucion_desbloqueo" => ["label" => "EJECUCION_DESBLOQUEO"],
