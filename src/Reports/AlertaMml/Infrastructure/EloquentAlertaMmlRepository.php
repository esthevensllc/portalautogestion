...
namespace AMovil\Reports\AlertaMml\Infrastructure;
...
class EloquentAlertaMmlRepository implements AlertaMmlRepository
{
    private $db;
    private $authService;
    ...
    {
        $this->userIdentifier = $this->authService->getUserIdentifier();
        DB::connection("ch-dn01")->table("cdrdatos.table_nintex_AlertaMml")
        ->insert([
    ...
    {
        return DB::connection("ch-dn01")->table("cdrdatos.table_nintex_AlertaMml")->get();
    }
