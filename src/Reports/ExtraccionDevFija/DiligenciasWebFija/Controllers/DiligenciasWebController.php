...
namespace AMovil\Reports\ExtraccionDevFija\DiligenciasWebFija\Controllers;

use AMovil\Reports\ExtraccionDevFija\DiligenciasWebFija\Services\DiligenciasWebFijaExporter;
...
class DiligenciasWebController
{
    ...
    public function __construct(DiligenciasWebFijaExporter $exporter){
    ...
    public function view()
    {
        $config = [
            ...
            "exportApi" => asset("extraccion-dev-fija/diligencias-web/export"),
        ];
        return view("extraccion_dev_fija.diligencias_web", compact("config"));
    }
