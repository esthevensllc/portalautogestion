...
class EloquentExtraccionDevFijaRepository implements ExtraccionDevFijaRepository
{
    ...
    public function getReportePostpago($ticket, $fuente)
    {
        ...
        ROUND(CASE
            ...
            WHEN MINUTOS_AFECTACION >= 700 AND MINUTOS_AFECTACION < 1440 THEN MINUTOS_AFECTACION * 3.5
            WHEN MINUTOS_AFECTACION >= 300 AND MINUTOS_AFECTACION < 700 THEN MINUTOS_AFECTACION * 3
            WHEN MINUTOS_AFECTACION >= 60 AND MINUTOS_AFECTACION < 300 THEN MINUTOS_AFECTACION * 2.5
            ELSE MINUTOS_AFECTACION
