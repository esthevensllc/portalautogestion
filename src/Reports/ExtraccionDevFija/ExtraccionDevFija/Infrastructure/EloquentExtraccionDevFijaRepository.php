...
class EloquentExtraccionDevFijaRepository implements ExtraccionDevFijaRepository
{
    ...
    public function getReportePostpago($ticket, $fuente)
    {
        ...
        CASE
            ...
            WHEN MINUTOS_AFECTACION > 700 THEN MINUTOS_AFECTACION * 3.5
            WHEN MINUTOS_AFECTACION > 300 THEN MINUTOS_AFECTACION * 3
            WHEN MINUTOS_AFECTACION > 60 THEN MINUTOS_AFECTACION * 2.5
        ...
        (CASE
            ...
            WHEN MINUTOS_AFECTACION > 60 THEN MINUTOS_AFECTACION * 2.5
            ELSE MINUTOS_AFECTACION
        END) / (ROUND(MONTO_PRINCIPAL * 1.18, 2) + INTERES) AS FACTOR_MULTIPLICATIVO,
        INTERES,
        TASA,
