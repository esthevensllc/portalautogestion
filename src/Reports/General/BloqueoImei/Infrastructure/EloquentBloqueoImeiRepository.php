...
class EloquentBloqueoImeiRepository implements BloqueoImeiRepository
{
    public function getReporte($id, $filename, $imeis, DateTime $fechaIni, DateTime $fechaFin)
    {
        ...
        x.pgw_address,x.charging_id,x.served_pdppdn_address,x.duration,x.charging_characteristics,
        ...
        (
            ...
            pgw_address,charging_id,served_pdppdn_address,duration,charging_characteristics,
