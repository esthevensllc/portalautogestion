...
class ReporteSigreiExport implements FromCollection, WithHeadings, WithStyles, WithColumnFormatting, ShouldAutoSize
{
    ...
    {
        return collect(DB::select(DB::RAW("select contador,imei, tipo, to_char(fecha, 'dd/mm/yyyy hh24:mi:ss') as fecha, numero_servicio_telefonico, apellido_paterno, apellido_materno, nombres, tipo_doc, nro_documento, razon_social from TMP_FINAL_2_{$this->userIdentifier}")));
        /*
