            ...
            <div class="mb-3 row">
                <div class="col-lg-3 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm" name="hora_inicio" placeholder="00:00:00" required>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm" name="hora_fin" placeholder="00:00:00" required>
                    </div>
                </div>
