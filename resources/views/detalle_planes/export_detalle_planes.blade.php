        ...
        <form id="form_export">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-lg-3 col-md-4 tabs">
                    <div class="form-group tab-item tab_3">
                        <label for="">Lineas</label>
                        <textarea class="form-control form-control-sm" name="lineas" required></textarea>
                        <div class="invalid-feedback d-block text-dark">
                            Ingrese valores separados por comas sin el codigo 51<br>
                            Ej. 947123456
                        </div>
                    </div>
                    <div class="form-group tab-item tab_4">
                    ...
                    <div class="form-group tab-item tab_1">
                        ...
                        <input type="text" class="form-control form-control-sm" name="num_documento" required>
                        <div class="invalid-feedback d-block text-dark">
