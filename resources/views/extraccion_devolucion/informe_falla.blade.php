            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">Formatos permitidos: xlsx, xls, xlsm, csv o pdf. Tamaño máximo: 50 MB.</small>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
...
$(function() {
    ...
    $(document).on('click', '.download-cronograma', function(e) {
        e.preventDefault();
        id = $(this).data('id');
        let downloadApi = "{{ url('extraccion-devolucion/informe-fallas/[numReporte]/cronograma/download') }}";
        window.open(downloadApi.replace('[numReporte]', id),"_blank");
    });
    ...
    $(document).on('click', '.delete-cronograma', function(e) {
        ...
        var deleteApi = "{{ url('extraccion-devolucion/informe-fallas/[numReporte]/cronograma/delete') }}";
    ...
    $('#frm-cronograma').on('submit', function(e) {
        ...
        var uploadApi = "{{ url('extraccion-devolucion/informe-fallas/[numReporte]/cronograma') }}";
