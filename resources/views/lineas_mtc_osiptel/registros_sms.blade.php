...
>
    <thead class="bg-danger">
        <tr>
            ...
            <th>Fecha</th>
            <th>Numero Post</th>
            <th>Numero Recibidos Post</th>
            <th>Numero No Recibidos Post</th>
            <th>Numero Pre</th>
            <th>Numero Recibidos Pre</th>
            <th>Numero No Recibidos Pre</th>
        </tr>
    </thead>
    <tbody>
    </tbody>
...
<script>
    ...
    const _datatable = $(".table").DataTable({
        ...
        columns: [
            ...
            {data: 'fecha'},
            {data: 'num_post'},
            {data: 'num_recibidospost'},
            {data: 'num_norecibidospost'},
            {data: 'num_pre'},
            {data: 'num_recibidospre'},
            {data: 'num_norecibidospre'},
        ],
        //serverSide: true,
        scrollX: true
    });
