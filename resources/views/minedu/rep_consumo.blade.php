            ...
            <div class="mb-3 row">
                <div class="col-lg-3 col-md-4">
                    <div class="form-group">
                        ...
                        <select id="tabs_select" name="tipo_input" class="form-control form-control-sm" required>
                            @foreach ($config["tipo_input"] as $row)
                ...
                <div class="col-lg-3 col-md-4 tabs">
                    <div class="form-group tab-item tab_1">
                        ...
                        <input type="file" name="excel" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" style="font-size: 0.85rem;" required>
                    </div>
                ...
                <div class="col-lg-2 col-md-4">
                    <div class="form-group">
                        ...
                        <select name="tipo_reporte" class="form-control form-control-sm" required>
                            @foreach ($config["reportes"] as $row)
                                <option value="{{ $row['id'] }}">{{ $row['label'] }}</option>
                            @endforeach
                        </select>
                    </div>
